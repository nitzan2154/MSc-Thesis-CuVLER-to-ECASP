...
\documentclass[MSc,fullpageDraft]{misc/iitthesis}
...
% NOTE! this must be after the thesis-fields include since important compiler globals where chnaged and we should import them again with /usepackage. For now, ignore the warning about /thesis-fields be added before \begin{document}, this is a workaround.
\input{preamble}
...
%
\include{main/1_intro}
\include{main/2_relatedwork}
\include{main/3_method}
\include{main/4_experiments}
\include{main/5_ablations}
...
% BEGIN SUPPLEMENTARY MATERIAL: supplementary_now (1).tex -- Multi-View Silhouette Refinement -- appendix inclusion

\appendix
\include{main/appendix_ecasp}

% END SUPPLEMENTARY MATERIAL: Multi-View Silhouette Refinement -- appendix inclusion
% \appendix
